            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: AppTypography.semiBold14.copyWith(
                            color: widget.isFlagged ? context.appColors.error : context.appColors.primary,
                          ),
                        ),
                      ),
                      AnimatedRotation(
                        ...
                        child: Icon(Icons.keyboard_arrow_down, color: context.appColors.textSecondary, size: 22.sp),
                      ),
                    ],
                  ),
                  SizedBox(height: 6.h),
                  ...
                  Row(
                    children: [
                      Icon(Icons.person_outline, size: 14.sp, color: context.appColors.textSecondary),
                      SizedBox(width: 6.w),
                      Expanded(
                        child: Text(
