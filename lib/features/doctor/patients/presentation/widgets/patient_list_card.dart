...
class PatientListCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusBg = isActive ? context.appColors.secondary : context.appColors.textSecondary.withValues(alpha: .12);
    final statusFg = isActive ? context.appColors.primary : context.appColors.textSecondary;
                ...
                ClipRRect(
                  ...
                  child: imageUrl != null
                      ...
                      : Container(
                          ...
                          child: Icon(Icons.person_outline, color: context.appColors.primary, size: 28.sp),
                        ),
                ),
                SizedBox(width: 14.w),
                Expanded(
