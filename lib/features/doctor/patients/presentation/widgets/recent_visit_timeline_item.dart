          ...
          Column(
            children: [
              Container(
                ...
                child: Icon(icon, color: AppColors.surfaceLight, size: 16.sp),
              ),
              if (!isLast)
                Expanded(
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title, style: AppTypography.semiBold16.copyWith(color: AppColors.textPrimaryLight)),
                  SizedBox(height: 2.h),
                  Text(dateAndBy, style: AppTypography.regular14.copyWith(color: AppColors.textSecondary)),
                  if (note != null) ...[
                    SizedBox(height: 6.h),
                    Text(
                      '"$note"',
