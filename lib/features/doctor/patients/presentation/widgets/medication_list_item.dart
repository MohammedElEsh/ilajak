          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(name, style: AppTypography.semiBold16.copyWith(color: AppColors.textPrimaryLight)),
                  SizedBox(height: 2.h),
                  Text(detail, style: AppTypography.regular14.copyWith(color: AppColors.textSecondary)),
                ],
              ),
            ),
