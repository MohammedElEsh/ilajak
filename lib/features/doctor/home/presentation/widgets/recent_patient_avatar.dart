        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              border: highlighted ? Border.all(color: context.appColors.primary, width: 2) : null,
            ),
            ...
            child: CircleAvatar(
              ...
              child: imageUrl == null
                  ? Icon(Icons.person_outline, color: context.appColors.primary, size: 26.sp)
                  : null,
            ),
          ),
          SizedBox(height: 8.h),
          SizedBox(
            ...
            child: Text(
              ...
              style: AppTypography.regular13.copyWith(color: context.appColors.textPrimary),
            ),
          ),
        ],
      ),
