...
class DoctorAppointmentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final accentColor = isLive ? context.appColors.primary : context.appColors.textSecondary;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isLive ? Border.all(color: context.appColors.primary, width: 1.5) : null,
        ),
        child: Row(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.person_outline, color: context.appColors.primary, size: 24.sp),
            ),
            SizedBox(width: 14.w),
            Expanded(
              child: Column(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          overflow: TextOverflow.ellipsis,
                          style: isLive
                              ? AppTypography.semiBold14.copyWith(color: context.appColors.primary)
              ...
              children: [
                if (room != null)
                  Container(
                    ...
                    child: Text(
                      room!,
                      style: AppTypography.regular12.copyWith(color: context.appColors.surface),
                    ),
                  ),
                SizedBox(height: 8.h),
                if (isLive)
