...
class DoctorScheduleAppointmentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusBg = isPending
        ? context.appColors.textSecondary.withValues(alpha: .12)
        : context.appColors.primary;
    final statusFg = isPending ? context.appColors.textSecondary : context.appColors.surface;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              CircleAvatar(
                ...
                child: imageUrl == null
                    ? Icon(Icons.person_outline, color: context.appColors.primary, size: 24.sp)
                    : null,
              ),
              SizedBox(width: 12.w),
              Expanded(
          ...
          Row(
            children: [
              Text(typeLabel, style: AppTypography.regular14.copyWith(color: context.appColors.textSecondary)),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 8.w),
                child: CircleAvatar(radius: 2.r, backgroundColor: context.appColors.textSecondary),
              ),
              Text(
                timeLabel,
