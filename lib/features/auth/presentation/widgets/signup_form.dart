      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20.h),
            Text(
              AppStrings.authSignupNationalId.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                color: colors.onSurfaceVariant,
              ),
            ),
            ...
            SizedBox(height: 20.h),
            Text(
              AppStrings.authSignupDateOfBirth.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                color: colors.onSurfaceVariant,
              ),
            ),
            ...
            SizedBox(height: 20.h),
            Text(
              AppStrings.authSignupGender.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                color: colors.onSurfaceVariant,
              ),
            ),
            ...
            SizedBox(height: 20.h),
            Text(
              AppStrings.authSignupBloodType.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                color: colors.onSurfaceVariant,
              ),
            ),
            ...
            SizedBox(height: 20.h),
            Text(
              AppStrings.authSignupAddress.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                color: colors.onSurfaceVariant,
              ),
            ),
            ...
            SizedBox(height: 20.h),
            Text(
              AppStrings.authSignupPassword.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                color: colors.onSurfaceVariant,
              ),
            ),
            ...
            SizedBox(height: 20.h),
            Text(
              AppStrings.authSignupConfirmPassword.tr(),
              style: theme.textTheme.bodyMedium?.copyWith(
                color: colors.onSurfaceVariant,
              ),
            ),
